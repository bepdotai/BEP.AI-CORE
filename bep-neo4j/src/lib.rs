...
//!
//! This crate is a companion crate to the [bep-core crate](https://github.com/bep-ai/bep-core).
//! It provides a vector store implementation that uses Neo4j as the underlying datastore.
//!
//! See the [README](https://github.com/bepdotai/bep/tree/main/bep-neo4j) for more information.
//!
//! ## Prerequisites
//!
//! ### GenAI Plugin
...
//!
//! ## Simple example:
//! More examples can be found in the [/examples](https://github.com/bepdotai/bep/tree/main/bep-neo4j/examples) folder.
//! ```
...
use neo4rs::*;
use bep::{embeddings::EmbeddingModel, vector_store::VectorStoreError};
use serde::Deserialize;
...
fn neo4j_to_bep_error(e: neo4rs::Error) -> VectorStoreError {
